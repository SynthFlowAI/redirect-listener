 ...
 *   properties.param3 = load_react_app_full_iframe yes/no
 *   properties.param4 = React iframe landing page, e.g. "agents"
 */
...
var LOAD_REACT_APP_FULL_IFRAME = typeof properties !== "undefined" && properties ? properties.param3 : "";
var REACT_IFRAME_LANDING_PAGE = typeof properties !== "undefined" && properties ? properties.param4 : "";
...
function isBubbleYesForCookie(v) {
  return v === true || /^(yes|true|1)$/i.test(String(v || "").trim());
}

function iframeSyncFnNameForCookie() {
  return isBubbleYesForCookie(LOAD_REACT_APP_FULL_IFRAME)
